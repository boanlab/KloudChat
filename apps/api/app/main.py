"""kchat API entry point.

The health probe reports kchat and LiteLLM separately: they are different
...
async def lifespan(app: FastAPI):
    log.info("kchat api starting (env=%s, signup_mode=%s)", settings.env, settings.signup_mode)
