...
class Settings(BaseSettings):
    ...
    # Headroom above the kchat allowance for the proxy-side budget. kchat is
    ...
    # ── downstream ─────────────────────────────────────────────────────
    #: kloudchat-backend gateway. Model and tool endpoints are derived from it
    ...
    # ── tool backends ──────────────────────────────────────────────────
    # All in kloudchat-backend, addressed from the admin screen. These are a
