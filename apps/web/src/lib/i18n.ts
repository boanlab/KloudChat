...
const EN: Record<string, string> = {
  ...
  '원문 읽기, 장애 원인 좁히기, 사실 확인… 일을 고르면 그 일에 필요한 것만 묻고 요청을 대신 씁니다.': 'Reading a source, narrowing down an outage, checking a fact… pick the task and it asks only for what that task needs, then writes the request for you.',
  '개념도, 처리 흐름도, 표지 그림… 그림의 쓰임을 고르면 빈칸 몇 개로 요청이 완성됩니다.': 'A concept diagram, a process flow, a cover image… pick what the picture is for and a few blanks complete the request.',
  '문헌 동향 조사, 의사결정 보고서, 논문 세미나 발표… 일을 고르면 필요한 것만 묻고 결과물 모양까지 정해 줍니다.': 'A literature survey, a decision report, a paper seminar… pick the task and it asks only for what it needs, and settles the shape of the result too.',
