...
const EN: Record<string, string> = {
  ...
  '작성자가 지침을 비공개로 공유한 에이전트입니다. 지침은 원본에서 읽어 오며, 여기서 보거나 고칠 수 없습니다. 이름·모델·스킬은 바꿀 수 있습니다.': 'The author shared this agent with its instructions withheld. They are read from the original and cannot be viewed or edited here; name, model and skills can be changed.',
  ...
  '가져갈 수 있지만 지침은 비공개': 'Take, but instructions stay private',
  '복사본은 내 원본의 지침으로 동작하되 지침을 보거나 고칠 수 없습니다. 내가 원본을 고치면 복사본도 따라옵니다.': 'Copies run on your original’s instructions without being able to read or edit them; editing the original updates them too.',
  '지침은 작성자만 봅니다. 가져가면 원본의 지침으로 동작합니다.': 'Only the author sees the instructions. A copy runs on the original’s.',
  '지침 비공개': 'Instructions private',
  ...
  '예: 단국대 컴퓨터공학과 교수. 클라우드 보안과 시스템 연구를 하고, 학부 수업과 대학원 지도를 맡고 있다. Python 과 Go 를 주로 쓴다.': 'e.g. Professor of computer science; research in cloud security and systems; teaches undergraduates and advises graduate students. Mostly Python and Go.',
