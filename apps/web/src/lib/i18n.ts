...
const EN: Record<string, string> = {
  ...
  '개념 배우기, 논문 읽기, 문제 원인 분석… 일을 고르면 그 일에 필요한 것만 묻고 요청을 대신 씁니다.': 'Learning a concept, reading a paper, analysing a problem… pick the task and it asks only for what that task needs, then writes the request for you.',
  ...
  '과제 보고서, 논문 서론, 임원 보고… 일을 고르면 필요한 것만 묻고 결과물 모양까지 정해 줍니다.': 'An assignment report, a paper introduction, an executive briefing… pick the task and it asks only for what it needs, and settles the shape of the result too.',
