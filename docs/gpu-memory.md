...
|---|---|---|---|
| 텍스트 채팅 (소형) | qwen3.5:9b | ~6GB | RTX 3080 10GB |
| 텍스트 채팅 (대형) | qwen3.5:35b | ~21GB | RTX 3090 / 4090 24GB |
| 텍스트 + 이미지 (SDXL) | qwen3.5:35b + ComfyUI(SDXL) | ~36GB | A100 80GB |
| 텍스트 + 이미지 (Qwen-Image) | qwen3.5:35b + ComfyUI(Qwen-Image) | ~44GB | A100 80GB |
| 코딩 특화 (Q4) | qwen3-coder-next(Q4) | ~52GB | A100 80GB |
| 코딩 특화 (Q8, 고품질) | qwen3-coder-next(Q8) | ~85GB | H100 80GB×2 |
