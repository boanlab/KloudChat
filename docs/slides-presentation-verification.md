...
- 390x844, 844x390, 1440x900의 Chromium 화면에서 18개 회귀를 실행함. 수정 전 9개 실패/9개 통과, 수정 후 18개 통과함.
...
- TypeScript 검사, production 빌드, API 전체 회귀 2,314개 통과/1개 건너뜀, API Ruff와 diff 검사를 완료함. API 회귀는 네트워크 전송을 차단한 별도 mock 검사임.
